...
export const NEIGHBORHOOD_DATA: NeighborhoodData[] = [
  ...
  },
  {
    ...
    name: 'Humble',
    type: 'suburb',
    description: 'Humble homeowners get the same insured and guaranteed service as anywhere in the Houston metro — no travel fee within our standard service area.',
  ...
  },
  {
    ...
    name: 'Friendswood',
    type: 'suburb',
    description: 'Friendswood\'s family-oriented community deserves reliable, professional handyman service — insured, on time, and backed by a 1-year guarantee.',
